...
public class Player1 : MonoBehaviour 
{
	...
	public void SetContrDesc(ControladorDeDescarga1 contr)
	{
		ContrDesc = contr;
	}
	
	public ControladorDeDescarga1 GetContr()
	{
		return ContrDesc;
	}
	...
	public void CambiarACalibracion()
	{
		...
		EstAct = Player1.Estados.EnCalibracion;
	}
	
	public void CambiarATutorial()
	{
		MiVisualizacion.CambiarATutorial();
		EstAct = Player1.Estados.EnTutorial;
		ContrTuto.Iniciar();
	}
	...
	public void CambiarAConduccion()
	{
		...
		EstAct = Player1.Estados.EnConduccion;
	}
	
	public void CambiarADescarga()
	{
		MiVisualizacion.CambiarADescarga();
		EstAct = Player1.Estados.EnDescarga;
	}
